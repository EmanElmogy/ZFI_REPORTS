...
form_name = 'ZDYNAMIC_CHECKS_PRINT_F'.
...
LOOP AT checks_table INTO ls_checks_table.


  CALL FUNCTION fm_name
    EXPORTING
      /1bcdwb/docparams = fp_docparams
      t_config          = ls_checks_table-t_config
      with_line         = ls_checks_table-with_line
    EXCEPTIONS
      usage_error       = 1
      system_error      = 2
      internal_error    = 3.
